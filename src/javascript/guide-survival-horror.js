...
document.addEventListener('DOMContentLoaded', function () {
  var items = [
    { id: 'alien-isolation', imgId: 'film-poster-alien-isolation' },
    { id: 'amnesia-the-dark-descent', imgId: 'film-poster-amnesia' },
    { id: 'silent-hill-1-game', imgId: 'film-poster-silent-hill' }
  ]
