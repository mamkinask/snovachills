...
var DIAGNOSTICS_QUESTIONS = [{
  ...
  options: [{
    text: 'За кадром. Пустота и намёк бьют сильнее',
    scores: {
      'Tension Level': 5
    }
  }, {
    text: 'Оба варианта по-своему. Нужен баланс',
    scores: {
      'Tension Level': 4
    }
  }, {
    text: 'Показывают. Хочу видеть источник страха',
    scores: {
      'Tension Level': 3
    }
  }]
  ...
  options: [{
    text: 'В глухую полночь — ни рассвета, ни сумерек',
    scores: {
      'Atmosphere': 'Тёмная и гнетущая',
      'Mood': 'Тревожное'
    }
  }, {
    text: 'В три — город спит, за окном пусто',
    scores: {
      'Atmosphere': 'Пригород'
    }
  }, {
    text: 'Перед рассветом — уже не ночь, но ещё не день',
    scores: {
      'Mood': 'Параноидальное'
    }
  }, {
    text: 'В лесу, когда не понять — день или ночь',
    scores: {
      'Atmosphere': 'Мрачная и изолированная'
    }
  }]
}, {
  ...
  options: [{
    text: 'Шаги, когда знаешь, что рядом никого нет',
    scores: {
      'Fear Type': 'Сверхъестественный'
    }
  }, {
    text: 'Чьё-то дыхание за спиной',
    scores: {
      'Fear Type': 'Маньяк'
    }
  }, {
    text: 'Скрип, стук — что-то неживое, но «живое»',
    scores: {
      'Fear Type': 'Монстры'
    }
  }, {
    text: 'Звук, который невозможно описать или повторить',
    scores: {
      'Fear Type': 'Монстры'
    }
  }]
  ...
  options: [{
    text: 'В тёмную, зная. Лучше враг, чем пустота',
    scores: {
      'Tension Level': 3,
      'Scare Level': 4
    }
  }, {
    text: 'В светлую, не зная. Неопределённость страшнее',
    scores: {
      'Tension Level': 5,
      'Scare Level': 3
    }
  }, {
    text: 'Оба варианта невозможны. Не вошёл бы ни в ту, ни в другую',
    scores: {
      'Scare Level': 5
    }
  }]
  ...
  options: [{
    text: 'С лицом. Чужое, но узнаваемое — невыносимее',
    scores: {
      'Fear Type': 'Монстры'
    }
  }, {
    text: 'Без лица. То, чего нельзя прочитать',
    scores: {
      'Fear Type': 'Монстры'
    }
  }, {
    text: 'Человеческое лицо, которое вдруг «съезжает»',
    scores: {
      'Fear Type': 'Маньяк'
    }
  }, {
    text: 'Пустота там, где должно быть лицо',
    scores: {
      'Fear Type': 'Сверхъестественный'
    }
  }]
  ...
  options: [{
    text: 'В городе. Оживлённое место, в котором ни души',
    scores: {
      'Atmosphere': 'Зловещая'
    }
  }, {
    text: 'Вдали от людей. Лес, поле, дорога в никуда',
    scores: {
      'Atmosphere': 'Мрачная и изолированная'
    }
  }, {
    text: 'В замкнутом пространстве — корабль, база, бункер',
    scores: {
      'Atmosphere': 'Странная и сновидческая'
    }
  }, {
    text: 'В старом доме, где когда-то жили, а теперь — тишина',
    scores: {
      'Atmosphere': 'Тёмная и гнетущая'
    }
  }]
  ...
  options: [{
    text: 'Убежать. Хотя бы иллюзия выбора',
    scores: {
      'Mood': 'Весёлое и безумное',
      'Genre': 'Слэшер'
    }
  }, {
    text: 'Не спрятаться. Так честнее',
    scores: {
      'Mood': 'Параноидальное'
    }
  }, {
    text: 'Страх, в котором не ясно — можно ли вообще убежать',
    scores: {
      'Mood': 'Тревожное',
  ...
  options: [{
    text: 'Извне. Призрак, существо, чужое',
    scores: {
      'Fear Type': 'Сверхъестественный',
      'Genre': 'Сверхъестественный хоррор'
    }
  }, {
    text: 'Внутри. Безумие, слом, предательство себя',
    scores: {
      'Fear Type': 'Психологический',
      'Genre': 'Психологический хоррор'
    }
  }, {
    text: 'Внутри тела — что-то растёт, меняется',
    scores: {
      'Fear Type': 'Монстры'
    }
  }, {
    text: 'Не понять, откуда. Оно везде и нигде',
    scores: {
      'Fear Type': 'Монстры',
      'Genre': 'Фантастический хоррор'
    }
  }]
}, {
  ...
  options: [{
    text: 'Открытый. Незнание хуже любой развязки',
    scores: {
      'Mood': 'Тревожное'
    }
  }, {
    text: 'Однозначно плохой. Безысходность до конца',
    scores: {
      'Mood': 'Параноидальное'
    }
  }, {
    text: 'Тот, где зло остаётся — не побеждённое',
    scores: {
      'Mood': 'Тревожное'
    }
  }, {
    text: 'С оттенком иронии — как будто всё это шутка',
    scores: {
      'Mood': 'Весёлое и безумное'
    }
  }]
  ...
  options: [{
    text: 'Бояться за героя. Ясно, кто враг, хочу переживать погоню',
    scores: {
      'Genre': 'Слэшер',
      'Scare Level': 4
    }
  }, {
    text: 'Не понимать. Пусть реальность плывёт',
    scores: {
      'Genre': 'Психологический хоррор',
      'Scare Level': 3
    }
  }, {
    text: 'И то и другое — чтобы и непонятно, и физически опасно',
    scores: {
      'Scare Level': 5
    }
  }]
  ...
  options: [{
    text: 'Есть правила. Можно пытаться выжить по ним — и ошибиться',
    scores: {
      'Genre': 'Сверхъестественный хоррор',
      'Tension Level': 4
    }
  }, {
    text: 'Правил нет. Невозможно предсказать',
    scores: {
      'Fear Type': 'Монстры',
      'Genre': 'Фантастический хоррор'
    }
  }, {
    text: 'Правила есть, но они бесчеловечны',
    scores: {
      'Fear Type': 'Маньяк'
    }
  }, {
    text: 'Угроза не следует логике — ни нашей, ни своей',
    scores: {
      'Fear Type': 'Сверхъестественный',
      'Genre': 'Сверхъестественный хоррор'
    }
  ...
  options: [{
    text: 'Укрытие. В темноте можно спрятаться',
    scores: {
      'Mood': 'Весёлое и безумное',
      'Scare Level': 2
    }
  }, {
    text: 'Угроза. В темноте что-то ждёт',
    scores: {
      'Mood': 'Тревожное',
      'Scare Level': 4
    }
  }, {
    text: 'И то и другое. Темнота не на твоей стороне',
    scores: {
      'Mood': 'Параноидальное',
      'Scare Level': 5
    }
  ...
  options: [{
    text: 'Забыть. Потерять память о близком',
    scores: {
      'Genre': 'Психологический хоррор',
      'Fear Type': 'Психологический'
    }
  }, {
    text: 'Быть забытым. Исчезнуть из чьей-то реальности',
    scores: {
      'Mood': 'Параноидальное',
      'Fear Type': 'Сверхъестественный'
    }
  }, {
    text: 'Оба варианта — про одиночество и потерю связи',
    scores: {
      'Mood': 'Тревожное'
    }
  }]
  ...
  options: [{
    text: 'В голове. Додуманное страшнее показанного',
    scores: {
      'Scare Level': 3,
      'Genre': 'Психологический хоррор'
    }
  }, {
    text: 'На экране. Хочу, чтобы ударили по нервам напрямую',
    scores: {
      'Scare Level': 5,
      'Genre': 'Слэшер'
    }
  }, {
    text: 'На стыке — когда не ясно, было ли это на самом деле',
    scores: {
      'Scare Level': 4
    }
  }]
  ...
  options: [{
    text: 'Того, кого не описать словами',
    scores: {
      'Fear Type': 'Монстры',
      'Genre': 'Фантастический хоррор'
    }
  }, {
    text: 'Того, кого когда-то знал',
    scores: {
      'Fear Type': 'Маньяк'
    }
  }, {
    text: 'То, что когда-то было человеком',
    scores: {
      'Fear Type': 'Монстры',
      'Genre': 'Зомби-хоррор'
    }
  }, {
    text: 'Никого — пустой тупик страшнее',
    scores: {
      'Fear Type': 'Сверхъестественный',
      'Genre': 'Сверхъестественный хоррор'
    }
...
function buildStepCard(questionIndex, q) {
  ...
  var imageHtml = q.imageUrl ? '<div class="test-card-image"><img src="' + escapeHtml(q.imageUrl) + '" alt=""></div>' : '<div class="test-card-image"></div>';
  ...
  card.innerHTML = imageHtml + '<div class="test-card-body">' + '<div class="test-card-header">' + '<span class="test-card-number">' + escapeHtml(numLabel) + ':</span>' + '<p class="test-card-question">' + escapeHtml(q.question) + '</p>' + '</div>' + '<div class="test-card-options">' + optionsHtml + '</div>' + '</div>' + '<div class="test-card-nav">' + '<button type="button" class="test-btn-back" id="test-prev-' + step + '">НАЗАД</button>' + '<button type="button" class="test-btn-next" id="test-next-' + step + '">ДАЛЕЕ</button>' + '</div>';
  return card;
}
...
function showStep(step) {
  ...
  dots.forEach(function (dot) {
    ...
    if (n === step) dot.classList.add('active');else if (n < step) dot.classList.add('done');
  });
...
function findBestMatch(profile, items) {
  ...
  var topItems = scored.filter(function (x) {
    return x.score >= topScore - 1;
  }).slice(0, 5);
...
function showResult() {
  ...
  stepsContainer.querySelectorAll('.test-card').forEach(function (el) {
    el.classList.remove('current');
  });
  progressContainer.querySelectorAll('.test-progress-dot').forEach(function (dot) {
...
function bindCard(card) {
  ...
  card.querySelectorAll('.test-card-option').forEach(function (btn) {
    btn.addEventListener('click', function () {
      ...
      card.querySelectorAll('.test-card-option').forEach(function (b) {
